...
class ConvocationAttachmentController
{
    ...
    public function __construct()
    {
        ...
        $this->uploadDir = rtrim($config['upload_dir'], '/') . '/convocation';
    ...
    {
        $convocationId = (int) $params['id'];
        $convocation = Convocation::getById($convocationId);
        if (!$convocation) {
            Response::notFound('Convocation introuvable');
        }

        $attachments = ConvocationAttachment::getByConvocationId($convocationId);
    ...
    public function store(array $params): void
    {
        ...
        $owner = self::sanitizeFilename($convocation['date_convocation'] ?? '');
        ...
        $id = ConvocationAttachment::create([
        ...
        $attachment = ConvocationAttachment::getById($id);
    ...
    public function update(array $params): void
    {
        ...
        $attachment = ConvocationAttachment::getById($attachId);
        if (!$attachment || !ConvocationAttachment::belongsToConvocation($attachId, $convocationId)) {
        ...
        ConvocationAttachment::update($attachId, ['title' => $data['title']]);
        $attachment = ConvocationAttachment::getById($attachId);
    ...
    public function destroy(array $params): void
    {
        ...
        ConvocationAttachment::delete($attachId);
        Response::success(null, 'Attachment deleted successfully');
    }

    /**
     * GET /api/convocations/{id}/attachments/{attachId}/download
     */
