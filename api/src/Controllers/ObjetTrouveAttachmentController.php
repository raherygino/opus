...
class ObjetTrouveAttachmentController
{
    ...
    public function __construct()
    {
        ...
        $this->uploadDir = rtrim($config['upload_dir'], '/') . '/objet_trouve';
    ...
    public function index(array $params): void
    {
        ...
        if (!ObjetTrouve::find($objetId)) {
            Response::notFound('Objet trouvé introuvable');
        }
        Response::success(ObjetTrouveAttachment::listForObjet($objetId));
    }
    ...
    public function store(array $params): void
    {
        ...
        $objetId = (int) $params['id'];
        $entry = ObjetTrouve::find($objetId);
        if (!$entry) {
            Response::notFound('Objet trouvé introuvable');
        }
        ...
        $id = ObjetTrouveAttachment::create([
        ...
        Response::created(ObjetTrouveAttachment::find($id), 'Attachment added successfully');
    }
    ...
    public function update(array $params): void
    {
        ...
        $attachment = ObjetTrouveAttachment::find($attachId);
        if (!$attachment || !ObjetTrouveAttachment::belongsToObjet($attachId, $objetId)) {
        ...
        ObjetTrouveAttachment::updateTitle($attachId, $data['title']);
        Response::success(ObjetTrouveAttachment::find($attachId), 'Attachment updated successfully');
    }
    ...
    public function destroy(array $params): void
    {
        ...
        ObjetTrouveAttachment::delete($attachId);
        Response::success(null, 'Attachment deleted successfully');
    }

    /**
     * GET /api/objets/trouve/{id}/attachments/{attachId}/download
     */
