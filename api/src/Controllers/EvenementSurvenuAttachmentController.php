...
class EvenementSurvenuAttachmentController
{
    ...
    public function __construct()
    {
        ...
        $this->uploadDir = rtrim($config['upload_dir'], '/') . '/evenements-survenus';
    ...
    {
        $evenementId = (int) $params['id'];
        $evenement = EvenementSurvenu::find($evenementId);
        if (!$evenement) {
            Response::notFound('Événement introuvable');
        }

        $attachments = EvenementSurvenuAttachment::getByEvenementId($evenementId);
    ...
    public function store(array $params): void
    {
        ...
        $owner = self::sanitizeFilename($evenement['lieu_exact'] ?? '');
        ...
        $id = EvenementSurvenuAttachment::create([
        ...
        $attachment = EvenementSurvenuAttachment::getById($id);
    ...
    public function update(array $params): void
    {
        ...
        $attachment = EvenementSurvenuAttachment::getById($attachId);
        if (!$attachment || !EvenementSurvenuAttachment::belongsToEvenement($attachId, $evenementId)) {
        ...
        EvenementSurvenuAttachment::update($attachId, ['title' => $data['title']]);
        $attachment = EvenementSurvenuAttachment::getById($attachId);
    ...
    public function destroy(array $params): void
    {
        ...
        EvenementSurvenuAttachment::delete($attachId);
        Response::success(null, 'Pièce jointe supprimée avec succès');
    }

    /**
     * GET /api/evenements-survenus/{id}/attachments/{attachId}/download
     */
