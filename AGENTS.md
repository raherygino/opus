...
- API tests: `php api/tests/CorrespondanceTest.php`, `php api/tests/NotificationTest.php`, `php api/tests/DeclarationPerteTest.php`, `php api/tests/PassationTest.php`, `php api/tests/ArmementTest.php`, `php api/tests/MaterielTest.php`, `php api/tests/RassemblementJournalierTest.php`
